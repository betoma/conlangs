...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item reflected in orthography
    \end{itemize}
    \item Nasals become voiced non-nasal stops before a voiceless obstruent
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item reflected in orthography
    \end{itemize}
    \item Two of the same consonant in a row merge into a single occurrence of that consonant. Fricatives following affricates at the same place of articulation are also deleted.
    \begin{itemize}
        \item syllabic consonants included
        \item reflected in orthography
    \end{itemize}
...
Reflexive\tablefootnote{Perhaps abnormally, reflexive forms for pronouns are used as subject pronouns rather than object pronouns} & \textit{tete\vd} & \textit{karkar} & \textit{teudteu\vn} & \textit{meum} & \textit{geog} & \textit{\vs u\vs} & \textit{himim} & \textit{eses} \\ \bottomrule
\end{tabular}
