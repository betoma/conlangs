...
%\textit{k\vl e} \bripa{kl\apico e} `arm' vs. \textit{kle} \bripa{kl\lamino e} `two'),
...
%\textit{kla\vr} \bripa{kl\lamino\alvr\apico\sylb} would not be a legal syllable in Geobo\engma{}, and a word \phipa{kl\lamino\schwa\alvr\apico} would surface as \bripa{kl\apico\alvr\apico\sylb} and be indistinguishable from \textit{k\vl a\vr} \phipa{kl\apico\schwa\alvr\apico}. 
